    ...
    public void bubbleSort() {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            for (int j = 0; j < n - 1 - i; j++) {
                ...
                if (currentReg.license.compareTo(nextReg.license) > 0) { // TODO 12: Uncomment the IF statement and complete it
                    // TODO 14: Swap the positions of the current and next Registration objects
