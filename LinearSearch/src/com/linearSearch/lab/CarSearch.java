...
public class CarSearch {
    ...
    public ArrayList searchAvailability(String availability) {
        ...
        for (Object obj : cars){
            Car car = (Car) obj;
            // TODO 2: Loop over the cars array, comparing the value of the availability field
    ...
    public ArrayList search(String make, String model, String color){
        ...
        for(Object obj : cars) {
            ...
            if(car.color.equals(color) && car.model.equals(model) && car.make.equals(make)) {
                /* TODO 7: if the make, model, and color of the Car instance match the method parameters, add it to the results ArrayList. */
                results.add(car);
            }
        }
        ...
        if (results.isEmpty()){
            ...
            System.out.println("There's no " + color + " " + make + " " + model + " available at this time. \n");
        }
    ...
    public ArrayList searchPrice(double priceLimit, boolean lowerThan){
        ...
        if(results.isEmpty()){
            ...
            System.out.println("There are no car priced " + (lowerThan ? "below" : "above") + " " + priceLimit);
        }
